...
export default function ShopJewelleryPage() {
    ...
    useEffect(() => {
        async function load() {
            const data = await getDbProductsByCategory("jewellery");
    ...
    const colors = useMemo(
        () => ["Gold", "Silver", "Pearl", "Rose Gold", "White", "Black"],
        []
    );
            ...
            <div className="mx-auto max-w-[1180px] px-6 pb-16 pt-24">
                ...
                <div className="mt-6">
                    ...
                    <h1 className="mt-3 text-5xl italic tracking-[-0.03em]">
                        Shop Jewellery <span className="text-black/35 text-3xl">({products.length})</span>
                    </h1>
